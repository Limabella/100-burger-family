...
MaAM의 큰 태엽을 가족이 함께 움직여 레스토랑의 피크타임을 완성합니다. 한 판은 약 5~10분을 목표로 하며, 같은 주문을 가족이 나누어 처리하면 더 빨리 마칠 수 있도록 설계합니다.

[첫 번째 피크타임 태엽 — 서사와 협력 플레이 기획](docs/PEAK_TIME_WINDING_STORY.md)

현재는 기획·구현 목표이며, 태엽과 가족 협력 기능의 완성을 뜻하지 않습니다.
